...
extension Operations {
    /// A model object
    public struct GetPlaylistContentsMedia {
        @DecimalSerialized
        ...
        public let part: [Operations.GetPlaylistContentsPart]?
        ...
        ///
        ///
        public init(aspectRatio: Double? = nil, audioChannels: Int? = nil, audioCodec: String? = nil, audioProfile: String? = nil, bitrate: Int? = nil, container: String? = nil, duration: Int? = nil, has64bitOffsets: Bool? = nil, height: Int? = nil, id: Int? = nil, optimizedForStreaming: Int? = nil, part: [Operations.GetPlaylistContentsPart]? = nil, videoCodec: String? = nil, videoFrameRate: String? = nil, videoProfile: String? = nil, videoResolution: String? = nil, width: Int? = nil) {
...
extension Operations.GetPlaylistContentsMedia: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.part = try container.decodeIfPresent([Operations.GetPlaylistContentsPart].self, forKey: .part)
...
extension Operations.GetPlaylistContentsMedia {
