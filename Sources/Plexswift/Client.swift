...
/// ### Server overrides
///
/// By default, API calls are made to `http://10.10.10.47:32400`. This can be configured using the ``use(server:)`` method, passing a ``GlobalServers`` value.
///
/// ## Topics
///
/// ### Initializers
...
public final class Client {
    ...
    /// Override the default server used when making connections to the API.
    ///
    /// By default, API calls are made to `http://10.10.10.47:32400`. Pass one of the values from the ``GlobalServers`` enumeration to override this.
