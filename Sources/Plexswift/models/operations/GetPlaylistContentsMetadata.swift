...
extension Operations {
    /// A model object
    public struct GetPlaylistContentsMetadata {
        ...
        public let country: [Operations.GetPlaylistContentsCountry]?
        public let director: [Operations.GetPlaylistContentsDirector]?
        public let duration: Int?
        public let genre: [Operations.GetPlaylistContentsGenre]?
        ...
        public let media: [Operations.GetPlaylistContentsMedia]?
        @DateOnly
        ...
        public let role: [Operations.GetPlaylistContentsRole]?
        ...
        public let writer: [Operations.GetPlaylistContentsWriter]?
        public let year: Int?

        /// Creates an object with the specified parameters
        ///
        ///
        public init(addedAt: Int? = nil, art: String? = nil, audienceRating: Double? = nil, audienceRatingImage: String? = nil, contentRating: String? = nil, country: [Operations.GetPlaylistContentsCountry]? = nil, director: [Operations.GetPlaylistContentsDirector]? = nil, duration: Int? = nil, genre: [Operations.GetPlaylistContentsGenre]? = nil, guid: String? = nil, hasPremiumExtras: String? = nil, hasPremiumPrimaryExtra: String? = nil, key: String? = nil, librarySectionID: Int? = nil, librarySectionKey: String? = nil, librarySectionTitle: String? = nil, media: [Operations.GetPlaylistContentsMedia]? = nil, originallyAvailableAt: Date? = nil, rating: Double? = nil, ratingImage: String? = nil, ratingKey: String? = nil, role: [Operations.GetPlaylistContentsRole]? = nil, studio: String? = nil, summary: String? = nil, tagline: String? = nil, thumb: String? = nil, title: String? = nil, titleSort: String? = nil, type: String? = nil, updatedAt: Int? = nil, writer: [Operations.GetPlaylistContentsWriter]? = nil, year: Int? = nil) {
...
extension Operations.GetPlaylistContentsMetadata: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.country = try container.decodeIfPresent([Operations.GetPlaylistContentsCountry].self, forKey: .country)
        self.director = try container.decodeIfPresent([Operations.GetPlaylistContentsDirector].self, forKey: .director)
        self.duration = try container.decodeIfPresent(Int.self, forKey: .duration)
        self.genre = try container.decodeIfPresent([Operations.GetPlaylistContentsGenre].self, forKey: .genre)
        ...
        self.media = try container.decodeIfPresent([Operations.GetPlaylistContentsMedia].self, forKey: .media)
        ...
        self.role = try container.decodeIfPresent([Operations.GetPlaylistContentsRole].self, forKey: .role)
        ...
        self.writer = try container.decodeIfPresent([Operations.GetPlaylistContentsWriter].self, forKey: .writer)
...
extension Operations.GetPlaylistContentsMetadata {
