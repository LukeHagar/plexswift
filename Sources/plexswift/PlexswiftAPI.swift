...
/// - ``getLatestLibraryItems(request:)``
/// - ``getCommonLibraryItems(request:)``
/// - ``getMetadata(request:)``
...
public protocol LibraryAPI {
    ...
    /// 
    /// 
    /// - Parameter request: A ``Operations/GetLatestLibraryItemsRequest`` object describing the input to the API operation
    /// - Returns: A ``Operations/GetLatestLibraryItemsResponse`` object describing the result of the API operation
    /// - Throws: An error of type ``PlexswiftError``
    func getLatestLibraryItems(request: Operations.GetLatestLibraryItemsRequest) async throws -> Response<Operations.GetLatestLibraryItemsResponse>

    /// Represents a "Common" item. It contains only the common attributes of the items selected by the provided filter
    /// 
    /// 
    /// - Parameter request: A ``Operations/GetCommonLibraryItemsRequest`` object describing the input to the API operation
    /// - Returns: A ``Operations/GetCommonLibraryItemsResponse`` object describing the result of the API operation
    /// - Throws: An error of type ``PlexswiftError``
    func getCommonLibraryItems(request: Operations.GetCommonLibraryItemsRequest) async throws -> Response<Operations.GetCommonLibraryItemsResponse>
...
public protocol LogAPI {
    ...
    /// - Throws: An error of type ``PlexswiftError``
    func logMultiLine() async throws -> Response<Operations.LogMultiLineResponse>
