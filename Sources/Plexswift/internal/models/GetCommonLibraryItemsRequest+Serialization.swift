...
extension Operations.GetCommonLibraryItemsRequest: Serializable {
    func serialize(with format: SerializableFormat) throws -> String {
        ...
        case .header, .multipart, .form:
            throw SerializationError.invalidSerializationParameter(type: "Operations.GetCommonLibraryItemsRequest", format: format.formatDescription)
        }
    }
...
extension Operations.GetCommonLibraryItemsRequest: PathParameterSerializable {
...
extension Operations.GetCommonLibraryItemsRequest: QueryParameterSerializable {
