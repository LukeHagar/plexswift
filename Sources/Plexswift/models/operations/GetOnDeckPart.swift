...
extension Operations {
    ...
    public struct GetOnDeckPart {
        ...
        ///
        ///
        public init(audioProfile: String? = nil, container: String? = nil, duration: Double? = nil, file: String? = nil, id: Double? = nil, key: String? = nil, size: Double? = nil, stream: [Operations.Stream]? = nil, videoProfile: String? = nil) {
...
extension Operations.GetOnDeckPart: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.stream = try container.decodeIfPresent([Operations.Stream].self, forKey: .stream)
