...
extension Operations {
    /// A model object
    public struct GetSourceConnectionInformationErrors {
        @DecimalSerialized
...
extension Operations.GetSourceConnectionInformationErrors: Codable {
...
extension Operations.GetSourceConnectionInformationErrors {
