...
extension Operations {
    ...
    public enum GetPinResponse {
        ...
        case fourHundredApplicationJsonObject(Operations.GetPinPlexTvResponseBody)
        ...
        public func fourHundredApplicationJsonObject() throws -> Operations.GetPinPlexTvResponseBody {
